...
//     strokeRoundRect, easeLogistic, wrap
// } from '../utils.js';
//
...
//             ext    : new Image()
//         };
//         this.icons.folder.src = 'assets/icons/folder-teal.svg';
...
//         const pageY = 4 * cssH;                      // 5th page → offset 4 × vh
...
//         if (idx !== -1) window.open(NOTE_LIST[idx].repo, '_blank');
//     };
//
//     draw(scrollY) {
...
//         /* ---- section header ---- */
//         ctx.save();
//         ctx.translate(marginX, pageY + top - 140);
...
//         ctx.fillText('view the archive', 2, 40);
//         ctx.restore();
//
//         /* ---- 4-card grid ---- */
...
//             const icoY = baseY + 22;
//             const icoX = baseX + 22;
//             const { folder, gh, ext } = this.icons;
//             if (folder.complete)
//                 ctx.drawImage(folder, icoX, icoY, ghSize, ghSize);
//             if (gh.complete)
//                 ctx.drawImage(gh, icoX + NOTEWORTHY.iconGap + ghSize,
//                     icoY, ghSize, ghSize);
//             if (p.ext && ext.complete)
//                 ctx.drawImage(ext, icoX + 2*(NOTEWORTHY.iconGap + ghSize),
//                     icoY, ghSize, ghSize);
//
//             /* title */
//             ctx.fillStyle = COLORS.light;
